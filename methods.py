...
Output:
fMRI.jpg Contains two sample pre-selected fMRI timeseries.
dFC.jpg Contains sample dFC(t) for the given time point.
LE1D.jpg Contains sample LE(t) for the given time point.
LE2D.jpg Contains sample LE(t)*LE(t)^T for the given time point.

Usage: 
    methods.py <subject> <timepoint> 
    
Arguments:

    <subject> Subject ID
    <timepoint> Selected timepoints
...
if __name__ == '__main__':
    ...
    #Gets subject ID and timepoint.
    arguments = docopt(__doc__)
    subject = arguments['<subject>']
    timepoint = arguments['<timepoint>']
    outlab = ('_'+subject+'_'+timepoint)
    ...
    #Plot dFC.
    infile = '../outputs/outcollect/dFC'+outlab+'.csv'
    ...
    #Save image.
    outfile = '../outputs/outcollect/dFC'+outlab+'.jpg'
    plt.savefig(outfile,bbox_inches='tight',dpi=720)
    plt.close() 
    
    #Plot LE.
    infile = '../outputs/outcollect/LE'+outlab+'.csv'
    ...
    #Save image.
    outfile = '../outputs/outcollect/LE1D'+outlab+'.jpg'
    plt.savefig(outfile,bbox_inches='tight',dpi=720)
    plt.close() 
    ...
    #Save image.
    outfile = '../outputs/outcollect/LE2D'+outlab+'.jpg'
    plt.savefig(outfile,bbox_inches='tight',dpi=720)
    plt.close() 
