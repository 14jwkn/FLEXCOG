%{
For the subject group and the specified k, calculate the average dFC(t)
strength and variability across edges for each state and across all
states for each subject.
Output:
strvar.h5 Average dFC(t) strength/variability values for the subject.
%}

%Define command line arguments.
function [] = Step35_r_LE_group_state_strvar(subfile,k,subject)
...
%Read in the dFC data for two runs.
