%{
For the subject group and the specified k, find the dynamics metrics for 
...
Output:
avg_substat.csv Dynamics metrics averaged across runs for each subject. 
%}

%Define command line arguments.
function [] = Step16_r_LE_group_statestat(subfile,k)
