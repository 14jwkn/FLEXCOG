...
# -*- coding: utf-8 -*-
"""
For the set of LE or dFC centroids at each k, print out the 2D images and 
...
Usage: 
    Step14_r_LE_group_statesort.py <subfile> <statetype> 
    
Arguments:

    <subfile> Subject file name
    <statetype> dFC or LE
...
if __name__ == '__main__':
    ...
    for kidx in range(knum):
        ...
        if reorder_k != []:
            states_LE = [states_LE[i-1] for i in reorder_k]
